...
The `label` argument can be used to plot and compare results from multiple slot limits. The last example simulates yield under two additional slot limits and creates a single figure to compare yield across the three slot limits.
