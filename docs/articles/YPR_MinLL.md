# Estimate yield based on one or more minimum length limits
...
``` r
# Build numeric vector for minimum length limits
minLL <- seq(from = 200, to = 500, by = 50)
# Single or variable minimum length limits can be specified by
# minLL <- c(500)
# minLL <- c(500, 525, 600)

# Build numeric vector for cf and cm
cf <- seq(from = 0.1, to = 0.9, by = 0.1)
cm <- seq(from = 0.1, to = 0.9, by = 0.1)
# single and variable cf and cm can be specified by
# cf <- c(0.10,0.45,0.75)

# Build numeric vector of lengths of interest to monitor
...
![](YPR_MinLL_files/figure-html/generate%20yield%20plot-1.png)
...
![](YPR_MinLL_files/figure-html/generate%20yield%20plot%20multiple%20MLL-1.png)
...
![](YPR_MinLL_files/figure-html/Plot%20of%20fish%20reaching%20450mm-1.png)
...
![](YPR_MinLL_files/figure-html/Plot%20of%20fish%20reaching%20all%20sizes-1.png)
...
![](YPR_MinLL_files/figure-html/Isoploths-1.png)
...
![](YPR_MinLL_files/figure-html/Isoploths-2.png)
