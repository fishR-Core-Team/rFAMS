...
`dpmBH_minLL()` function requires the following arguments:
...
The `dpmBH_minLL` function will use all the arguments above to simulate
the population and generate a list with two data.frame object. The first
