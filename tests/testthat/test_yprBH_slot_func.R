...
test_that("yprBH_slot_func() messages",{
  ...
  yprBH_slot_func(recruitmentTL=200,lowerSL=250,upperSL=325,
  ...
  yprBH_slot_func(recruitmentTL=200,upperSL=325,
                  cfunder=0.25,cfin=0,cfabove=0.15,cm=0.4,
                  lhparms=LH) |>
    expect_error("Need to specify a lower slot limit total length")

  yprBH_slot_func(recruitmentTL=200,lowerSL=250,
                  cfunder=0.25,cfin=0,cfabove=0.15,cm=0.4,
                  lhparms=LH) |>
  ...
  yprBH_slot_func(recruitmentTL=275,lowerSL=250,upperSL=325,
                  cfunder=0.25,cfin=0,cfabove=0.15,cm=0.4,
                  lhparms=LH,loi=c(200,300)) |>
    expect_error("'recruitmentTL' must be less than or equal to 'lowerSL'")
  yprBH_slot_func(recruitmentTL=600,lowerSL=250,upperSL=325,
                  cfunder=0.25,cfin=0,cfabove=0.15,cm=0.4,
                  lhparms=LH,loi=c(200,300)) |>
  ...
  yprBH_slot_func(recruitmentTL=200,lowerSL=450,upperSL=325,
                  cfunder=0.25,cfin=0,cfabove=0.15,cm=0.4,
                  lhparms=LH,loi=c(200,300)) |>
    expect_error("'lowerSL' must be less than 'upperSL'")
  yprBH_slot_func(recruitmentTL=200,lowerSL=650,upperSL=725,
                  cfunder=0.25,cfin=0,cfabove=0.15,cm=0.4,
                  lhparms=LH,loi=c(200,300)) |>
    expect_error("The lower slot limit total length \\(=650\\) mm cannot be greater")
  yprBH_slot_func(recruitmentTL=200,lowerSL=c(250,275),upperSL=325,
                  cfunder=0.25,cfin=0,cfabove=0.15,cm=0.4,
                  lhparms=LH,loi=c(200,300)) |>
  ...
  yprBH_slot_func(recruitmentTL=200,lowerSL=250,upperSL=625,
                  cfunder=0.25,cfin=0,cfabove=0.15,cm=0.4,
                  lhparms=LH,loi=c(200,300)) |>
    expect_error("The upper slot limit total length \\(=625\\) mm cannot be greater")
  yprBH_slot_func(recruitmentTL=200,lowerSL=250,upperSL=c(300,325),
                  cfunder=0.25,cfin=0,cfabove=0.15,cm=0.4,
                  lhparms=LH,loi=c(200,300)) |>
...
LH <- makeLH(N0=100,tmax=15,Linf=592,K=0.20,t0=-0.3,LWalpha=-5.528,LWbeta=3.273)
pslot1a <- yprBH_slot_func(recruitmentTL=200,lowerSL=250,upperSL=325,
                           cfunder=0.25,cfin=0,cfabove=0.15,cm=0.4,
                           lhparms=LH)
pslot1b <- yprBH_slot_func(recruitmentTL=200,lowerSL=250,upperSL=325,
                           cfunder=0.25,cfin=0,cfabove=0.15,cm=0.4,
                           lhparms=LH,loi=c(200,300))
...
LH <- makeLH(N0=100,tmax=15,Linf=592,K=0.20,t0=-0.3,LWalpha=-5.528,LWbeta=3.273,
             restype="vector")
pslot2a <- yprBH_slot_func(recruitmentTL=200,lowerSL=250,upperSL=325,
                           cfunder=0.25,cfin=0,cfabove=0.15,cm=0.4,
                           lhparms=LH)
pslot2b <- yprBH_slot_func(recruitmentTL=200,lowerSL=250,upperSL=325,
                           cfunder=0.25,cfin=0,cfabove=0.15,cm=0.4,
                           lhparms=LH,loi=c(200,300))
## ..... harvest slot with and without loi
