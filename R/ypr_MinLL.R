...
#' }
#'
#' For convenience the data.frame also contains the model input values: \code{minLL} (may be derived from \code{minLL}, \code{minLLmin}, and \code{minLLinc}); \code{cf} (may be derived from \code{cf}, \code{cfmax}, and \code{cfinc}); \code{cm} (may be derived from \code{cm}, \code{cmmax}, and \code{cminc}); \code{N0}; \code{Linf}; \code{K}; \code{t0}; \code{LWalpha}; \code{LWbeta}; and \code{maxage}).
#'
